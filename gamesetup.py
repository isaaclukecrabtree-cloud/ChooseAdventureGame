...
def handle_wizard_intro(game_player):
    ...
    match choice:
        ...
        case 2:
            print("Wizard: I understand, this was merely a test of your heart, "
                  "the quest lies before you nevertheless")
            print("-1 Charisma.")
            game_player.charisma -= 1
...
def start_game():
    ...
    handle_wizard_intro(game_player)
    return game_player